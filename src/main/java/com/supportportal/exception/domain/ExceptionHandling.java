...
//  ** A way to remove white label spring page for not found NOT RECOMENDED
//    @ExceptionHandler(NoHandlerFoundException.class)
//    public ResponseEntity<HttpResponse> noHandlerFoundException(HttpRequestMethodNotSupportedException ex) {
